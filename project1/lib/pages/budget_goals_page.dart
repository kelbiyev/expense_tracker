...
class BudgetGoalsPage extends StatelessWidget {
  const BudgetGoalsPage({super.key, required List<Transaction> transactions, required List<BudgetGoal> budgetGoals});
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    const Text('Bu ayın büdcəsi', style: TextStyle(color: Colors.white70, fontSize: 14)),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ClipRRect(
                        ...
                        child: LinearProgressIndicator(value: ratio, color: category.color, backgroundColor: Colors.grey.shade200, minHeight: 8),
                      ),
                      if (isNearLimit) ...[
                        ...
                        Row(
                          children: [
                            ...
                            Text('${category.label} limitə yaxınlaşır', style: const TextStyle(color: Colors.orange, fontSize: 12)),
                          ],
                        ),
                      ],
                    ],
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: const Text('Yeni bir hədəf əlavə et', style: TextStyle(color: Colors.white)),
                ),
              ),
            ),
            const SizedBox(height: 16),
